    ...
    <div className="flex flex-wrap items-center gap-2">
      {isAuthenticated ? (
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-full bg-primary py-2 pr-4 pl-3 text-sm font-bold text-white shadow-md shadow-primary-500/40 transition hover:bg-primary-600"
        >
